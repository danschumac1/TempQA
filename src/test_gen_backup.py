...
def parse_args():
    ...
    parser.add_argument('--config_type', type=str, required=True, help='What type of generation config to load')
...
def main(): 
    ...
    # Argument Parsing
    args = parse_args()
    training_context = args.model_path.split('/')[-1]
    logger.info(f"Running test_gen ||| training_context: {training_context}, eval_context: {args.eval_context}, model: {args.model}, dataset: {args.dataset},")
